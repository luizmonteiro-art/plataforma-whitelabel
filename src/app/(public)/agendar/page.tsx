      ...
      <div className="bg-[#0d0d0d] border-b border-white/[0.04] py-12 sm:py-14">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-6 mt-5 text-xs text-zinc-600">
            <div className="flex items-center gap-1.5"><Shield size={12} className="text-[var(--accent)]" /> 90 dias garantia</div>
            <div className="flex items-center gap-1.5"><Clock size={12} className="text-[var(--accent)]" /> Resposta rápida</div>
            <div className="flex items-center gap-1.5"><Star size={12} className="text-[var(--accent)]" /> Técnicos certificados</div>
          </div>
        </div>
      </div>
